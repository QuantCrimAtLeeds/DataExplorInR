...
where $n_e$ is the number of $expected_{\delta,\tau}$ exceeded by the $n_{\delta,\tau}$, and $n_2$ is the total number of iteration (e.g. 999). 
...
print(paste("time taken to fill cell:", tt-1,",", ss-1 ))
